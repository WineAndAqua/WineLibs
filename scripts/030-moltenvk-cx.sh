...
if [ ! -d crossover-sources-20240808 ]; then
    if [ ! -f crossover-sources-20240808.tar.gz ]; then exit 1; fi
    tar xf crossover-sources-20240808.tar.gz
    mv sources crossover-sources-20240808
fi

if [ ! -d moltenvk ]; then
    cp -R crossover-sources-20240808/moltenvk .
