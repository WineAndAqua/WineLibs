...
if [ ! -d crossover-sources-20241028 ]; then
    if [ ! -f crossover-sources-20240925.tar.gz ]; then exit 1; fi
    tar xf crossover-sources-20240925.tar.gz
    mv sources crossover-sources-20240925
fi
...
if [ ! -d moltenvk ]; then
    ...
    rm -rf moltenvk/External/SPIRV-Cross
    cp -R crossover-sources-20240925/moltenvk/External/SPIRV-Cross moltenvk/External
